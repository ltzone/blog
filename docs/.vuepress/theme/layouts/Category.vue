    ...
    <ModuleTransition>
      <ul v-show="recoShowModule" class="category-wrapper">
        <li
          ...
          v-for="(item, index) in this.$recoCategories"
          :key="index">
...
import { sortPostsByStickyAndDate, filterPosts, filterPostsByLang } from '@theme/helpers/postData'
...
export default {
  ...
  computed: {
    ...
    posts () {
      ...
      posts = filterPostsByLang(posts, this.$lang)
